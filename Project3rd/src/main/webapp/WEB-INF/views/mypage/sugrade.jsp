	...
	<div class="contents">
		...
		<div class="rightcontents">
			...
			<div>
				...
				<input type="hid-den" name="year" value="<%=year %>" id="year"/><!-- 저장을 누를때 넘겨줄값이 들어있는곳 -->
				<input type="hid-den" name="semester" value="<%=semester %>" id="semester"/><!-- 저장을 누를때 넘겨줄값이 들어있는곳 -->
				<input type="hid-den" name="id" value="<%=id %>" id="id"/><!-- 저장을 누를때 넘겨줄값이 들어있는곳 -->
				<table class="table">
					<thead>
						<tr>
							<th>교과</th>
