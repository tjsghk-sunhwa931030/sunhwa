...
function Delete(){
	...
	location.href='./delete.do?bname=${bname }&idx=${idx }&nowPage=${nowPage }';
}
	else{
		return false;
	}
...
<style>
	...
	.re_table{width:100%; border-top:1px solid red;}
	...
	.re_link:hover{font-weight:bold;}
	...
	<div class="contents" style="height:2000px;">
		...
		<div class="rightcontents">
			...
			<tbody>
				...
				<tr>  
					<c:if test="${not empty viewRow.attachedfile }">
			...
			<span style="float:right;">
				...
				<button type="button" class="btn btn-dark" onclick="location.href='./edit.do?bname=${bname }&idx=${idx }&nowPage=${nowPage }';">수정</button>
				<button type="button" class="btn btn-dark" id="delBtn" name="delBtn" onclick="Delete();">삭제</button>
				</c:if>
				<button type="button" class="btn btn-dark" onclick="location.href='./board.do?bname=${bname }&nowPage=${nowPage}';">목록</button>
			</span> 
			</form>	
		...
		<div class="replywrite" style="margin-top:30px; width:100%; height:150px; background-color:#F7F7F7; ">
			<form name="refrm" action="./rewrite.do " onsubmit="return rewriteValidate(this);" >
