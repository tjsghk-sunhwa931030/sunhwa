...
<body>
	...
	<div class="topcontents">
      ...
      <div class="righttop">
         <div class="righttoptext">내 주변 독서실</div>
      </div>
   </div> 
	<div class="contents">
		<div class="leftmenu">
			<nav class="left1" >
				<ul class="navbar-nav1  bg-light ">
					<li class="nav-item1"><a class="nav-link" href="./board.do?bename=free">공부꿀팁<i class='fas fa-chevron-circle-right' style='margin-top:4px;'></i></a></li>
		...
		<div class="rightcontents">
			<div class="map" style="width:95%; height:500px; background-color:gray;">
			지도에 내 위치찍고 주변 도서관/독서실 보여주기
			</div> 
		</div>
	</div>
