...
function deleteRow(re_idx){
	...
	if(confirm('댓글을 삭제하시겠습니까?')==true){
		location.href='qnaReDelete.do?re_idx='+re_idx+'&idx='+idx+'&nowPage='+nowPage;
	}
} 
...
function editRow(re_idx){
	...
	$("#btnDo").on('click',function(){
		location.href='./qnaView.do?idx=${b_idx}&nowPage=${nowPage}'
	});
...
function reWriteRow(re_idx, rgroup, rstep, name){
	...
	a += "<form name='refrm' action='./qnaReReWrite.do' onsubmit='return rewriteValidate(this)'>"; 
