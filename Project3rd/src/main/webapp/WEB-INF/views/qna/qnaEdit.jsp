...
<body>
	...
	<div class="contents" style="height:900px;">
		...
		<div class="rightcontents" >
			...
			<form id="writeFrm" name="writeFrm" action="<c:url value="./qnaEditAction.do" />" method="post" enctype="multipart/form-data">
				...
				<tbody>
					<tr>
						...
						<td>
							<input type="text" class="form-control" name="name" value="${dto.name }" readonly style="width:200px;" />
						</td>
					</tr> 
					<tr>
					...
					<tr> 
						...
						<td>
							<input type="text" class="form-control" name="title" value="${dto.title }" style="" />
						</td>
					</tr>
					<tr>
				...
				<div class="buttons" style="float:right; width:140px;">
					...
					<button type="button" class="btn btn-dark" onclick="location.href='./qna.do?nowPage=${nowPage}';">취소</button>
				</div>
			</form>
			</div>
		</div>
