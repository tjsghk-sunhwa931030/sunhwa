...
function diagnose(idx, recruit_time, id, uname){
	$.ajax({
		type: "POST",
		url: "get_grade.do",
		dataType: "html",
		data: {idx: idx, recruit_time: recruit_time, id: id, uname: uname},
...
<%@include file="../main/head.jsp" %> 
	...
	<div class="contents" style="height: 2300px">
		<div class="leftmenu">
			<nav class="left1" >
		...
		<div class="rightcontents" >
			...
			<form id="checkFrm" name="checkFrm" action="./u_grade_checkAction.do" method="get" onsubmit="return checkboxFrm();">
							...
							<tbody id="tbResult">
								...
								<tr>	
									...
									<td scope="col" rowspan="2">
										<button type="button" class="btn btn-success" onclick="diagnose(${rowj.idx },'${rowj.recruit_time }', '${sessionScope.siteUserInfo }', '${rowj.univ_uname }');">진단</button>
									</td>
